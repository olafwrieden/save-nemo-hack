...
/**
 * Parses the role claim and returns an object of user roles.
 * @param claim roles claim string
 * @returns object of Org Roles
 */
export const parseRoleClaim = (claim: string): OrgRole[] => {
  const pairs = claim
    .trim()
    .split(";")
    .filter((i) => i);
